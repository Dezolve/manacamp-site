    ...
    <section className="relative min-h-screen flex items-center justify-center overflow-hidden">
      <div className="absolute inset-0 -z-10">
        ...
        <motion.div
          ...
          className="absolute top-1/4 left-[16%] w-[34rem] h-[34rem] ambient-blue rounded-full blur-3xl"
        />
        <motion.div
          animate={{
            scale: [1.2, 1, 1.2],
          ...
          className="absolute bottom-[16%] right-[14%] w-[24rem] h-[24rem] ambient-ember rounded-full blur-3xl"
        />
        <motion.div
          animate={{
            scale: [1, 1.3, 1],
          ...
          className="absolute top-[42%] right-[28%] w-72 h-72 bg-accent-support/10 rounded-full blur-3xl"
        />
        <div className="absolute inset-0 bg-[linear-gradient(180deg,transparent,rgba(4,8,18,0.3))]" />
      </div>

      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pt-28 pb-12">
        <div className="grid grid-cols-1 gap-14 lg:grid-cols-[minmax(0,1fr)_minmax(0,540px)] lg:items-center">
          <div className="text-center lg:text-left">
            ...
            >
              <Link
                href="#download"
                className="btn-primary w-full sm:w-auto px-8 py-4 rounded-full font-semibold text-base transition-all duration-200 hover:-translate-y-0.5"
              >
                Download for Windows
              </Link>
              <Link
                href="#ios"
                className="btn-secondary w-full sm:w-auto px-8 py-4 rounded-full font-semibold text-base transition-all duration-200 hover:-translate-y-0.5"
              >
                Join iOS Waitlist
              </Link>
            </motion.div>
            ...
            <motion.div
              ...
              className="mt-10 flex flex-wrap items-center justify-center lg:justify-start gap-3 text-sm text-text-muted"
            >
          ...
          <motion.div
            ...
            className="relative"
          >
            <div className="absolute -inset-8 ambient-blue opacity-90 blur-3xl" />
            <div className="absolute -bottom-10 right-8 w-40 h-40 ambient-ember blur-3xl" />
            <div className="panel-strong relative rounded-[2rem] p-3 sm:p-4 border shadow-[0_40px_120px_rgba(3,9,24,0.65)]">
              <div className="rounded-[1.65rem] border border-[rgba(134,178,255,0.14)] bg-[linear-gradient(180deg,rgba(10,17,32,0.98),rgba(8,13,24,0.96))] overflow-hidden">
                ...
                <div className="grid grid-cols-[88px_minmax(0,1fr)] sm:grid-cols-[108px_minmax(0,1fr)] min-h-[420px]">
                  ...
                  <div className="grid grid-rows-[auto_minmax(0,1fr)_auto]">
                    <div className="flex items-center justify-between px-5 py-4 border-b border-border-subtle bg-[rgba(11,18,35,0.78)]">
                      <div>
                    ...
                    <div className="p-5 sm:p-6 space-y-4 bg-[radial-gradient(circle_at_top,rgba(53,104,192,0.12),transparent_32%)]">
                      {[
                        {
                          name: "Kai",
                        ...
                        <div key={message.name} className="rounded-2xl border border-border-subtle bg-[rgba(255,255,255,0.02)] px-4 py-3 text-left">
                    ...
                    <div className="flex items-center justify-between gap-4 px-5 py-4 border-t border-border-subtle bg-[rgba(8,13,24,0.94)]">
