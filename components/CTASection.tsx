...
export default function CTASection() {
  return (
    <section className="section-divider py-24 relative overflow-hidden">
          ...
          <div className="panel-strong relative rounded-3xl overflow-hidden border-[rgba(116,164,255,0.22)]">
            ...
            <div className="relative px-8 sm:px-16 py-16 sm:py-20 text-center">
              ...
              <div className="flex flex-col sm:flex-row items-center justify-center gap-4">
                <Link
                  href="#download"
                  className="btn-primary w-full sm:w-auto px-8 py-4 rounded-full font-semibold text-base transition-all duration-200 flex items-center justify-center gap-2 hover:-translate-y-0.5"
                >
