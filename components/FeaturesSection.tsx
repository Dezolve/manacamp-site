...
export default function FeaturesSection() {
  return (
    <section id="features" className="section-divider py-24 relative overflow-hidden">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
          {features.map((feature, index) => {
            ...
            return (
              ...
              >
                <div
                  className="panel group p-6 rounded-2xl transition-all duration-300 hover:-translate-y-1 hover:border-border-strong cursor-default"
                >
                  <div
